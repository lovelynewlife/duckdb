#include "duckdb/plugin/physical/storage/buffer/block_handle.hpp"
...
#include "duckdb/plugin/physical/storage/buffer/buffer_pool.hpp"
#include "duckdb/plugin/physical/common/file_system/file_buffer.hpp"
