...
#include "duckdb/plugin/physical/execution/operator/helper/physical_batch_collector.hpp"
#include "duckdb/plugin/physical/execution/operator/helper/physical_materialized_collector.hpp"
