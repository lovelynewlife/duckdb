...
#include "duckdb/plugin/physical/execution/operator/helper/physical_explain_analyze.hpp"
#include "duckdb/plugin/physical/execution/operator/scan/physical_column_data_scan.hpp"
