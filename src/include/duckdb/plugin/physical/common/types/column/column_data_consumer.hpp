...
//                         DuckDB
//
// duckdb/plugin/physical/common/types/column/column_data_consumer.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "duckdb/plugin/physical/common/types/column/column_data_collection_segment.hpp"
#include "duckdb/plugin/physical/common/types/column/column_data_scan_states.hpp"
