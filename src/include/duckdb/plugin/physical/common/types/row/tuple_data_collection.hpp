...
//                         DuckDB
//
// duckdb/plugin/physical/common/types/row/tuple_data_collection.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "duckdb/plugin/physical/common/types/row/tuple_data_segment.hpp"
#include "duckdb/plugin/physical/common/types/row/tuple_data_states.hpp"
