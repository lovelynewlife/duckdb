...
//                         DuckDB
//
// duckdb/plugin/physical/storage/compression/patas/algorithm/patas.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "duckdb/plugin/physical/storage/compression/chimp/algorithm/byte_writer.hpp"
#include "duckdb/plugin/physical/storage/compression/chimp/algorithm/ring_buffer.hpp"
#include "duckdb/plugin/physical/storage/compression/chimp/algorithm/byte_reader.hpp"
...
#include "duckdb/plugin/physical/storage/compression/patas/shared.hpp"
