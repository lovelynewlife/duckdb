...
if '--extended' in sys.argv:
    ...
    main_header_files += [
        ...
        for x in [
            ...
            'duckdb/plugin/physical/storage/object_cache.hpp',
            ...
            "duckdb/plugin/physical/common/arrow/arrow_wrapper.hpp",
            "duckdb/plugin/physical/common/file_system/hive_partitioning.hpp",
            "duckdb/common/union_by_name.hpp",
            "duckdb/planner/operator/logical_get.hpp",
            "duckdb/plugin/physical/common/file_system/compressed_file_system.hpp",
        ]
    ]
